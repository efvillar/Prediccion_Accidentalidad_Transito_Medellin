...
plot_ly(data=Total_Dataset_Freq,
        ...
        split = ~GRAVEDAD,
         ine=list(width=1))%>%
  layout(title='Evolucion por gravedad del accidente diarios en Medellin',
         xaxis=list(title="Dia"),
         yaxis=list(title="No Accidentes"))
```

El comportartamiento mensual por ano nos permite identificar una caida importante en el numero de acciedentes de transito en el mes de enero. A su vez permite identificar una caida recurrente en los meses de enero, abril, junio y noviembre.
