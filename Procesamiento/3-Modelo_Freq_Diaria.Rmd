...
Feriado+Feriado_v1+Feriado_Lunes+Feriado_Otro+Previo_feriado+Semana_Santa+Semana_Santa_Mes+Semana_Santa_Semana+Prima+Mujer+Padre+Madre+AmoryAmistad+Semana_Santa_v1+Viernes_Antes_Puente+Quincena+Viernes_Desp_Quincena+Viernes_Desp_Quincena_v1+Viernes_Desp_Quincena_v2+Feria_Flores+Feria_Flores_Mes+Feria_Flores_Semana
...
points (81, reg.summary$adjr2[81], col ="red",cex =2, pch =20)
```
```{r}
plot(reg.summary$cp ,xlab =" Number of Variables ",ylab="Cp",
type='l')
which.min (reg.summary$cp )
points (47, reg.summary$cp [47], col ="red",cex =2, pch =20)
which.min (reg.summary$bic )
plot(reg.summary$bic ,xlab=" Number of Variables ",ylab=" BIC",
type='l')
points (46, reg.summary$bic [46], col =" red",cex =2, pch =20)
```
```{r}
