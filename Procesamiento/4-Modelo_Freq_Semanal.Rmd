...
```{r}
library(dplyr)
Total_Dataset_Freq_S<-unite_(Total_Dataset_Freq_S, "Ano_Sem", c("ANO..6","SEMANA..7"))
```
...
```{r}
library (leaps)
regfit.fwd=regsubsets (TOTAL_ACCIDENTES∼ANO+SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros,Train_S_Dataset, method ="forward", nvmax= 80)
summary (regfit.fwd)
...
caret_lm_fit_s = caret::train(TOTAL_ACCIDENTES∼ANO+SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset,
...
```{r}
y_tr_pred_lm_s<-predict(caret_lm_fit_s,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
```{r}
y_test_pred_lm_s<-predict(caret_lm_fit_s,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_lm_fit_s_m = caret::train(ACCIDENTES_GRAVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset,
                      method = "lm", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_lm_s_m<-predict(caret_lm_fit_s_m,Train_S_Dataset[,c("SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_lm_s_m<-predict(caret_lm_fit_s_m,Test_S_Dataset[,c("SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_lm_fit_s_sd = caret::train(ACCIDENTES_LEVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset,
                      method = "lm", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_lm_s_sd<-predict(caret_lm_fit_s_sd,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_lm_s_sd<-predict(caret_lm_fit_s_sd,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_knn_fit_s = caret::train(TOTAL_ACCIDENTES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset,
...
```{r}
y_tr_pred_knn_s<-predict(caret_knn_fit_s,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
```{r}
y_test_pred_knn_s<-predict(caret_knn_fit_s,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_knn_fit_s_m = caret::train(ACCIDENTES_GRAVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset,
                      method = "knn", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_knn_s_m<-predict(caret_knn_fit_s_m,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_knn_s_m<-predict(caret_knn_fit_s_m,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_knn_fit_s_sd = caret::train(ACCIDENTES_LEVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset,
                      method = "knn", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_knn_s_sd<-predict(caret_knn_fit_s_sd,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_knn_s_sd<-predict(caret_knn_fit_s_sd,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
```{r}
glm_fit_s<-glm(TOTAL_ACCIDENTES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset, family = "poisson")
summary(glm_fit_s)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_glm_s<-predict(glm_fit_s,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")],type="response")
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_glm_s<-predict(glm_fit_s,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")],type="response")
...
```{r}
glm_fit_s_m<-glm(ACCIDENTES_GRAVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset, family = "poisson")
summary(glm_fit_s)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_glm_s_m<-predict(glm_fit_s_m,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")],type="response")
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_glm_s_m<-predict(glm_fit_s_m,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")],type="response")
...
```{r}
glm_fit_s_sd<-glm(ACCIDENTES_LEVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset, family = "poisson")
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_glm_s_sd<-predict(glm_fit_s_sd,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")],type="response")
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_glm_s_sd<-predict(glm_fit_s_sd,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")],type="response")
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_tree_fit_s = caret::train(TOTAL_ACCIDENTES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros,data=Train_S_Dataset,
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_tree_s<-predict(caret_tree_fit_s,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
  y_test_pred_tree_s<-predict(caret_tree_fit_s,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_tree_fit_s_m = caret::train(ACCIDENTES_GRAVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros,data=Train_S_Dataset,
                              method = "rpart", trControl = trcntrl,
                      parms = list(split = "gini"),
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_tree_s_m<-predict(caret_tree_fit_s_m,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_tree_s_m<-predict(caret_tree_fit_s_m,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_tree_fit_s_sd = caret::train(ACCIDENTES_LEVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros,data=Train_S_Dataset,
                              method = "rpart", trControl = trcntrl,
                      parms = list(split = "gini"),
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_tree_s_sd<-predict(caret_tree_fit_s_sd,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
  y_test_pred_tree_s_sd<-predict(caret_tree_fit_s_sd,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
trcntrl = trainControl(method="cv", number=10)
caret_rf_fit_s = caret::train(TOTAL_ACCIDENTES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset,
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_rf_s<-predict(caret_rf_fit_s,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_rf_s<-predict(caret_rf_fit_s,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
trcntrl = trainControl(method="cv", number=10)
caret_rf_fit_s_m = caret::train(ACCIDENTES_GRAVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset,
                      method = "rf", trControl = trcntrl,
                      prox=TRUE,allowParallel=TRUE)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_rf_s_m<-predict(caret_rf_fit_s_m,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_rf_s_m<-predict(caret_rf_fit_s_m,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
trcntrl = trainControl(method="cv", number=10)
caret_rf_fit_s_sd = caret::train(ACCIDENTES_LEVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Train_S_Dataset,
                      method = "rf", trControl = trcntrl,
                      prox=TRUE,allowParallel=TRUE)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_rf_s_sd<-predict(caret_rf_fit_s_sd,Train_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_rf_s_sd<-predict(caret_rf_fit_s_sd,Test_S_Dataset[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
...
```{r}
comparacion_tr<-data.frame(ANO=Total_Dataset_Freq_S$ANO[Total_Dataset_Freq_S$ANO<="2017"],
                          ACCIDENTES=Total_Dataset_Freq_S$TOTAL_ACCIDENTES[Total_Dataset_Freq_S$ANO<="2017"],
                           lm= y_tr_pred_lm_s, 
                           knn= y_tr_pred_knn_s, 
                           glm=y_tr_pred_glm_s ,
...
```{r}
comparacion_vl<-data.frame(ANO=Test_S_Dataset$ANO,
...
Calculo de la variación del RMSE de validación y entrenamiento
```{r}
#Porcetaje<-round(C((((RMSE_test_lm_s_sd-RMSE_tr_lm_s_sd)/RMSE_tr_lm_s_sd)*100),(((RMSE_test_lm_s_sd-RMSE_tr_lm_s_sd)/RMSE_tr_lm_s_sd)*100),(((RMSE_test_lm_s_sd-RMSE_tr_lm_s_sd)/RMSE_tr_lm_s_sd)*100),(((RMSE_test_lm_s_sd-RMSE_tr_lm_s_sd)/RMSE_tr_lm_s_sd)*100),(((RMSE_test_lm_s_sd-RMSE_tr_lm_s_sd)/RMSE_tr_lm_s_sd)*100),))
```
...
library(caret)
trcntrl = trainControl(method="cv", number=10)
caret_lm_fit_s_final = caret::train(TOTAL_ACCIDENTES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Total_Dataset_Freq_S,
                      method = "lm", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
```{r}
saveRDS(caret_lm_fit_s_final,"../Modelos/Prediccion_Total_Diario.rds")
```
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_tree_fit_s_m_final = caret::train(ACCIDENTES_GRAVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros,data=Total_Dataset_Freq_S,
                              method = "rpart", trControl = trcntrl,
                      parms = list(split = "gini"),
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
...
```{r}
caret_tree_fit_s_m_final
```


Se guardan el modelo en un objeto de r
```{r}
saveRDS(caret_tree_fit_s_m_final,"../Modelos/Prediccion_Grave_Diario.rds")
```
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_lm_fit_s_sd_final = caret::train(ACCIDENTES_LEVES∼SEMANA+Feria_Flores_Semana+Semana_Santa_Semana+Feriados_Lunes+Feriados_Otros, data=Total_Dataset_Freq_S,
                      method = "lm", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
Se guardan el modelo en un objeto de r
```{r}
saveRDS(caret_lm_fit_s_sd_final,"../Modelos/Prediccion_leves_Diario.rds")
```
...
```{r}
datos_pronostico_diario<-Dias_Especiales[,c("Fecha","ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")]
```
...
```{r}
datos_pronostico_diario$prediccion_Total<-predict(Modelo_Total_diario,datos_pronostico_diario[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
```

Predicción de accidentes graves con el modelo de árbol de regresión

```{r}
datos_pronostico_diario$prediccion_Graves<-predict(Modelo_Grave_diario,datos_pronostico_diario[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
```
...
```{r}
datos_pronostico_diario$prediccion_Leves<-predict(Modelo_leves_diario,datos_pronostico_diario[,c("ANO","SEMANA","Feria_Flores_Semana","Semana_Santa_Semana","Feriados_Lunes","Feriados_Otros")])
```
