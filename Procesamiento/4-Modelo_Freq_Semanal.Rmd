---
title: "MODELO FRECUENCIA SEMANAL"
...
Calculo MSE y RMSE para los datos de validación 
```{r}
  y_test_pred_tree_s<-predict(caret_tree_fit_s,Test_S_Dataset[,c("Feria_Flores_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_tree_s_m<-predict(caret_tree_fit_s_m,Test_S_Dataset[,c("Feria_Flores_Semana","Feriados_Lunes","Feriados_Otros")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
  y_test_pred_tree_s_sd<-predict(caret_tree_fit_s_sd,Test_S_Dataset[,c("Feria_Flores_Semana","Feriados_Lunes","Feriados_Otros")])
