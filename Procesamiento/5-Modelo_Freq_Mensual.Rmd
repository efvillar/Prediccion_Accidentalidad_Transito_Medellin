...
caret_lm_fit_m = caret::train(TOTAL_ACCIDENTES∼Ano_Base+MES+Freq_lunes+Freq_martes+Freq_miercoles+Freq_jueves+Freq_viernes+Freq_sabado+Freq_domingo+Feriados+Feriados_Lunes+Feriados_Otro, data=Train_M_Dataset ,
...
library(caret)
trcntrl = trainControl(method="cv", number=10)
caret_lm_fit_m = caret::train(TOTAL_ACCIDENTES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes, data=Train_M_Dataset ,
                      method = "lm", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
```{r}
y_tr_pred_lm_m<-predict(caret_lm_fit_m,Train_M_Dataset [,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes","Freq_viernes","Feriados_Lunes")])
...
```{r}
y_test_pred_lm_m<-predict(caret_lm_fit_m,Test_M_Dataset[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes","Freq_viernes","Feriados_Lunes")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_lm_fit_m_m = caret::train(ACCIDENTES_GRAVES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes, data=Train_M_Dataset ,
                      method = "lm", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_lm_m_m<-predict(caret_lm_fit_m_m,Train_M_Dataset [,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes","Freq_viernes","Feriados_Lunes")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_lm_m_m<-predict(caret_lm_fit_m_m,Test_M_Dataset[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes","Freq_viernes","Feriados_Lunes")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_lm_fit_m_sd = caret::train(ACCIDENTES_LEVES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes, data=Train_M_Dataset ,
                      method = "lm", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_lm_m_sd<-predict(caret_lm_fit_m_sd,Train_M_Dataset [,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes","Freq_viernes","Feriados_Lunes")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_lm_m_sd<-predict(caret_lm_fit_m_sd,Test_M_Dataset[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes","Freq_viernes","Feriados_Lunes")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_knn_fit_m = caret::train(TOTAL_ACCIDENTES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes, data=Train_M_Dataset ,
...
```{r}
y_tr_pred_knn_m<-predict(caret_knn_fit_m,Train_M_Dataset [,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")])
...
```{r}
y_test_pred_knn_m<-predict(caret_knn_fit_m,Test_M_Dataset[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_knn_fit_m_m = caret::train(ACCIDENTES_GRAVES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes, data=Train_M_Dataset ,
                      method = "knn", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_knn_m_m<-predict(caret_knn_fit_m_m,Train_M_Dataset [,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_knn_m_m<-predict(caret_knn_fit_m_m,Test_M_Dataset[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")])
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_knn_fit_m_sd = caret::train(ACCIDENTES_LEVES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes, data=Train_M_Dataset ,
                      method = "knn", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_knn_m_sd<-predict(caret_knn_fit_m_sd,Train_M_Dataset [,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")])
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_knn_m_sd<-predict(caret_knn_fit_m_sd,Test_M_Dataset[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")])
...
```{r}
glm_fit_m<-glm(TOTAL_ACCIDENTES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes, data=Train_M_Dataset , family = "poisson")
summary(glm_fit_m)
```
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_glm_m<-predict(glm_fit_m,Train_M_Dataset [,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")],type="response")
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_glm_m<-predict(glm_fit_m,Test_M_Dataset[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")],type="response")
...
```{r}
glm_fit_m_m<-glm(ACCIDENTES_GRAVES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes, data=Train_M_Dataset , family = "poisson")
summary(glm_fit_m_m)
```
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_glm_m_m<-predict(glm_fit_m_m,Test_M_Dataset[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")],type="response")
...
```{r}
glm_fit_m_sd<-glm(ACCIDENTES_LEVES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes, data=Train_M_Dataset , family = "poisson")
...
Calculo MSE y RMSE para los datos de entrenamiento 
```{r}
y_tr_pred_glm_m_sd<-predict(glm_fit_m_sd,Train_M_Dataset [,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")],type="response")
...
Calculo MSE y RMSE para los datos de validación 
```{r}
y_test_pred_glm_m_sd<-predict(glm_fit_m_sd,Test_M_Dataset[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")],type="response")
...
library(caret)
trcntrl = trainControl(method="cv", number=10)
caret_lm_fit_m_final = caret::train(TOTAL_ACCIDENTES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes, data=Total_Dataset_Freq_M,
                      method = "lm", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
```{r}
summary(caret_lm_fit_m_final)
```


Se guardan el modelo en un objeto de r
```{r}
saveRDS(caret_lm_fit_m_final,"../Modelos/Prediccion_Total_Diario.rds")
```
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_tree_fit_m_m_final = caret::train(ACCIDENTES_GRAVES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes,data=Total_Dataset_Freq_M,
                              method = "rpart", trControl = trcntrl,
                      parms = list(split = "gini"),
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
...
```{r}
caret_tree_fit_m_m_final
```


Se guardan el modelo en un objeto de r
```{r}
saveRDS(caret_tree_fit_m_m_final,"../Modelos/Prediccion_Grave_Diario.rds")
```
...
```{r}
trcntrl = trainControl(method="cv", number=10)
caret_lm_fit_m_sd_final = caret::train(ACCIDENTES_LEVES∼Ano_Base+MES+Feriados+Freq_viernes+Feriados_Lunes, data=Total_Dataset_Freq_M,
                      method = "lm", trControl = trcntrl,
                      preProcess=c("center", "scale"),
                      tuneLength = 10)
```
...
Se guardan el modelo en un objeto de r
```{r}
saveRDS(caret_lm_fit_m_sd_final,"../Modelos/Prediccion_leves_Diario.rds")
```
...
```{r}
datos_pronostico_diario<-Dias_Especiales[,c("Fecha","Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")]
```
...
```{r}
datos_pronostico_diario$prediccion_Total<-predict(Modelo_Total_diario,datos_pronostico_diario[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")])
```

Predicción de accidentes graves con el modelo de árbol de regresión

```{r}
datos_pronostico_diario$prediccion_Graves<-predict(Modelo_Grave_diario,datos_pronostico_diario[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")])
```
...
```{r}
datos_pronostico_diario$prediccion_Leves<-predict(Modelo_leves_diario,datos_pronostico_diario[,c("Ano_Base","MES","Feriados","Freq_viernes","Feriados_Lunes")])
```
