...
```{r}
Total_Dataset_Freq$Accidentes_Leves <- + Total_Dataset_Freq$`SOLO DAÃâOS`
```
...
### Total Accidentes
```{r}
set.seed(123) # fija la semilla del generador de nÃºmeros para que sea reproducible
```
...
### REsumen Modelos RegresiÃ³n lineal para los diferentes tipos de accidente
...
plot_ly (data=Test_D_Dataset,
  ...
  layout(title='Total Accidentes leves',
         ...
         legend = list(x = 0.75, y = 0.9))
```
### REsumen Modelos RegresiÃ³n lineal generalizado para los diferentes tipos de accidente
